...
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset", "dataset_mask")
...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "fisheye_mask_model.pth")
ANALYSIS_DIR = os.path.join(PROJECT_ROOT, "analysis", "fisheye_mask")
LOG_DIR = os.path.join(PROJECT_ROOT, "logs")
LOG_FILE = os.path.join(LOG_DIR, "logs_fisheye_mask.log")
