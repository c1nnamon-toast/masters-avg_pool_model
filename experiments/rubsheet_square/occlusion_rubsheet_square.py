...
irradiance predictions on the rubsheet_square test set (square-cropped
polar-to-Cartesian unwrap).
...
def make_occlusion_attr_fn(occ, device, patch_size, stride, baseline_value):
    """Return a callable that computes an Occlusion attribution map (not normalised)."""
