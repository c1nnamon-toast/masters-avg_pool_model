...
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset", "dataset_rubsheet_2to1")
...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "rubsheet_2to1_model.pth")
ANALYSIS_DIR = os.path.join(PROJECT_ROOT, "analysis", "rubsheet_2to1")
LOG_DIR = os.path.join(PROJECT_ROOT, "logs")
LOG_FILE = os.path.join(LOG_DIR, "logs_rubsheet_2to1.log")

# Hyperparameters
# Image size: 1068x534 (2:1 aspect ratio rubsheet)
