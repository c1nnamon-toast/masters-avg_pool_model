...
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset", "dataset_rubsheet")
...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "rubsheet_model.pth")
ANALYSIS_DIR = os.path.join(PROJECT_ROOT, "analysis", "rubsheet")
LOG_DIR = os.path.join(PROJECT_ROOT, "logs")
LOG_FILE = os.path.join(LOG_DIR, "logs_rubsheet.log")
