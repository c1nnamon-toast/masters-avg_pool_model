...
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset", "dataset_mask_crop_rubsheet")
...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "mask_crop_rubsheet_model.pth")
ANALYSIS_DIR = os.path.join(PROJECT_ROOT, "analysis", "mask_crop_rubsheet")
LOG_DIR = os.path.join(PROJECT_ROOT, "logs")
LOG_FILE = os.path.join(LOG_DIR, "logs_mask_crop_rubsheet.log")

# Hyperparameters
# Image size: 3041x484 (rubsheet from cropped masked images - smaller circle)
