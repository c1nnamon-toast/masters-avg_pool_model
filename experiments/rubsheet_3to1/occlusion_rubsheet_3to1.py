"""Occlusion attribution analysis for the rubsheet_3to1 experiment.

Uses Captum's Occlusion (sliding-window perturbation) to explain SkyCNN's
irradiance predictions on the rubsheet_3to1 test set.
...
Note: rubsheet_3to1 images are 1602×534 px (wide panoramic strips).

Run
---
    python experiments/rubsheet_3to1/occlusion_rubsheet_3to1.py
"""
...
# Rubsheet_3to1 images are 1602×534 px.
# patch=34 (≈ 1/16 of height) and stride=17 (half-patch)
PATCH_SIZE     = 34
STRIDE         = 17
BASELINE_VALUE = 0.0
...
def main():
    ...
    logger.info("=== Occlusion Attribution — Rubsheet 3-to-1 ===")
    logger.info(
