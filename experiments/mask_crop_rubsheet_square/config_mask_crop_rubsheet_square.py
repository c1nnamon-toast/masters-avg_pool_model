...
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset", "dataset_mask_crop_rubsheet_square")
...
MODEL_SAVE_PATH = os.path.join(PROJECT_ROOT, "models", "mask_crop_rubsheet_square_model.pth")
ANALYSIS_DIR = os.path.join(PROJECT_ROOT, "analysis", "mask_crop_rubsheet_square")
LOG_DIR = os.path.join(PROJECT_ROOT, "logs")
LOG_FILE = os.path.join(LOG_DIR, "logs_mask_crop_rubsheet_square.log")

# Hyperparameters
# Image size: 484x484 (3:1 compressed rubsheet from cropped masked images)
