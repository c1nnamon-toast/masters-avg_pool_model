...
from experiments.rubsheet.main_rubsheet \
    import main as run_rubsheet
from experiments.rubsheet_square.main_rubsheet_square \
    import main as run_rubsheet_square
from experiments.fisheye_mask.main_fisheye_mask \
    import main as run_fisheye_mask
from experiments.fisheye_mask_crop.main_fisheye_mask_crop \
    import main as run_fisheye_mask_crop
from experiments.rubsheet_3to1.main_rubsheet_3to1 \
    import main as run_rubsheet_3to1
from experiments.mask_rubsheet.main_mask_rubsheet \
    import main as run_mask_rubsheet
from experiments.mask_rubsheet_square.main_mask_rubsheet_square \
    import main as run_mask_rubsheet_square
from experiments.mask_crop_rubsheet.main_mask_crop_rubsheet \
    import main as run_mask_crop_rubsheet
from experiments.mask_crop_rubsheet_square.main_mask_crop_rubsheet_square \
    import main as run_mask_crop_rubsheet_square
from experiments.rubsheet_2to1.main_rubsheet_2to1 \
    import main as run_rubsheet_2to1
